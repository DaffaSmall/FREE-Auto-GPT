...
from FreeLLM import DeepAIChatAPI   # FREE DEEPAI API
from FreeLLM import ChatBaseChatAPI # FREE CHATBASE API
...
if select_model == "1":
    ...
    llm = DeepAIChatAPI.DeepAIChat()

elif select_model == "6":
    llm = ChatBaseChatAPI.ChatBaseChat()
